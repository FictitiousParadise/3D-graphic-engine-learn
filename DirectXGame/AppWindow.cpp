...
{
	//Updating the important matrices
	updateCamera();
	updateLight();
	updateSkyBox();
}
...
void AppWindow::updateCamera()
{
	...
	m_proj_cam.setPerspectiveFovLH(1.57, ((float)width / (float)height), 0.1f, 100.0f);
}
...
//+= means inverted, -= means view will move with the mouse, which we do not want
