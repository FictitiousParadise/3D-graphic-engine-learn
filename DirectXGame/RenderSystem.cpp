...
VertexBufferPtr RenderSystem::createVertexBuffer(void* list_vertices, UINT size_vertex, UINT size_list, void* shader_byte_code,
...
{
    m_imm_context->RSSetState(cull_front ? m_cull_front_state : m_cull_back_state);
}
